...
public class SalvarLivroAction extends Action {
	...
	public void process() throws Exception {
		...
		// Se existem erros, recolocar os dados na request e retornar para a própria página
		if (existemErros()) {
		...
		// Criar e popular os dados no livro
	...
	/**
	 * Recolocar os dados preenchidos na request, para permitir que o formulário já fique preenchido quando a tela for 
	 * recarregada
	 * @param id
	 * @param titulo
	 * @param autor
	...
	/**
	 * Adicionar um erro de validação. Os erros são armazenados em uma lista, inserida na request
	 * @param erro
	 */
